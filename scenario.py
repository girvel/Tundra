...
# Scenes
сценарий.сцена("Пролог. Исход", "Иней медленно покрывал кружку с заледеневшим чаем. С глухим звуком разгерметизации отворилась круглая дверь. %ГГ% открыл глаза.")
